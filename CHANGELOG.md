...
### **RRV Integration**
**Improvements**
- **Faster, Leaner Data Loading** — repo ZIP now writes to disk while downloading (no double read), and Hypixel API data streams instead of loading entire multi-MB JSON trees into memory (~50% less peak RAM)
